...
gPath = "."
gFirstFileName = "images/atlas_img.jpg"
gSecondFileName = "images/section_img.jpg"
...
class MyLabel(QLabel):
    ...
    def contextMenuEvent(self, event):
        ...
        if action == openAction:
            ...
            if okPressed:
                coord = funcLandmarkDetection(self.imageFile, 400)
                # print(coord)

                for pos in coord:
                    self.points.append(QPoint(pos[0], pos[1]))
                self.update()
